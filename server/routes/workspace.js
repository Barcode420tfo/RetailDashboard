import {Router} from 'express';import mongoose from 'mongoose';import {randomUUID} from 'node:crypto';import {Region,Store,Executive,ExecutiveEvent,Transaction,ReportingPeriod,RegionalReportingPeriod,Agent,Cluster} from '../models/index.js';import {validDay} from '../models/shared.js';import {requireRegion,requireAnalyst,requirePeopleEditor,seesAllRegions,isRestricted} from '../middleware/access.js';
